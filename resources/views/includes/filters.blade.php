<div class="row">
    <form class="form-inline" action="{{$filter_route}}" method="GET" id="{{$filter_id}}">
        <div class="col-md-12">
            ...
            <div class="form-group pr-2">
                <label class="pr-1" for="customer">{{__('Customer')}} </label>
            ...
            <div class="form-group pr-2">
                <label class="pr-1" for="supplier">{{__('Supplier')}} </label>
