      ...
      <a href="#" class="sidebar-toggle" data-toggle="push-menu" role="button">
       ...
       <a href="#" class="dropdown-toggle sidebar-toggle quick-icon" role="button" data-toggle="dropdown" id="menu1">
        ...
        <ul class="dropdown-menu quick-dropdown" role="menu" aria-labelledby="menu1">
          ...
          <li role="presentation"><a role="menuitem" tabindex="-1" href="{{route('items.create')}}"><i class="fa fa-product-hunt" aria-hidden="true"></i> {{__('Items')}}</a></li>
          @endif
          @if(auth()->user()->checkSpPermission('expense.create'))
          <li role="presentation"><a role="menuitem" tabindex="-1" href="{{route('expense.create')}}"><i class="fa fa-credit-card" aria-hidden="true"></i> {{__('Expenses')}}</a></li>
          @endif
          @if(auth()->user()->checkSpPermission('customers.create'))
          <li role="presentation"><a role="menuitem" tabindex="-1" href="{{route('customers.create')}}"><i class="fa fa-user-plus" aria-hidden="true"></i> {{__('Customers')}}</a></li>
          @endif
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-footer">
                ...
                <div class="pull-right">
                  <a href="{{ route('logout') }}" onclick="event.preventDefault();document.getElementById('logout-form').submit();" class="btn btn-success btn-flat">{{trans('menu.logout')}}</a>
