    ...
    <div class="modal-body" >
        <div class="row">
            <div class="col-md-12" >
                ...
                <div class="form-group row">
                    {{ Form::label('size', __('Size') .' *',['class'=>'col-sm-3 text-right']) }}
                    <div class="col-sm-9">
                        {{ Form::text('size', null, array('class' => 'form-control', 'required', 'rows'=>3)) }}
                    </div>
                </div>
                <div class="form-group row">
                    {{ Form::label('weight', __('Weight') .' *',['class'=>'col-sm-3 text-right']) }}
                    <div class="col-sm-9">
